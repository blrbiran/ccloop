...
import { ControlProtocolError, type StartEnvelopeV2 } from "./protocol.js";
...
export async function collectExecution(input: StartEnvelopeV2, afterSeq: number): Promise<CollectionV1> {
...
export async function inspectExecution(input: StartEnvelopeV2): Promise<ExecutionStatusV1> {
